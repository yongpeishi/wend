...
class Feedback
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(value: T.nilable(::String)).returns(T.nilable(::String)) }
    def element_selector=(value); end

    sig { returns(T::Boolean) }
    def element_selector?; end

    sig { returns(T.nilable(::String)) }
    def element_selector_before_last_save; end

    sig { returns(T.untyped) }
    def element_selector_before_type_cast; end

    sig { returns(T::Boolean) }
    def element_selector_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def element_selector_change; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def element_selector_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def element_selector_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def element_selector_in_database; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def element_selector_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def element_selector_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def element_selector_previously_was; end

    sig { returns(T.nilable(::String)) }
    def element_selector_was; end

    sig { void }
    def element_selector_will_change!; end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_element_selector?(from: T.unsafe(nil), to: T.unsafe(nil)); end
