...
# produces the same records (everything is found-or-created by a natural key,
...
priya = User.find_or_create_by!(email: "priya@example.com") do |u|
  u.name = "Priya"
...
japan = entry!(
  kind: "trip", title: "Japan", created_by: priya,
...
kyoto_day = entry!(kind: "bundle", title: "Kyoto: temples and dinner", created_by: sam)
link!(parent: japan, child: kyoto_day)

nanzenji = entry!(
  kind: "idea", title: "Nanzen-ji", category: "place", created_by: sam,
...
dinner_options = entry!(kind: "bundle", title: "Kyoto dinner options", created_by: sam)
link!(parent: kyoto_day, child: dinner_options)

ramen_dinner = entry!(
  kind: "idea", title: "Ramen at Gion Ramen Koji", category: "food", created_by: sam,
...
kaiseki_dinner = entry!(
  kind: "idea", title: "Kaiseki at Giro Giro Hitoshina", category: "food", created_by: priya,
...
hotel = entry!(
  kind: "idea", title: "Hotel Granvia Kyoto", category: "lodging", created_by: priya,
...
teamlab = entry!(
  kind: "idea", title: "teamLab Planets", category: "activity", created_by: sam,
...
pocket_wifi = entry!(
  kind: "idea", title: "Pocket wifi rental", category: "other", created_by: priya,
  notes: "Pick up at Narita arrivals, return at departure."
)
link!(parent: japan, child: pocket_wifi)

shinkansen = entry!(
  kind: "idea", title: "Shinkansen: Tokyo to Kyoto", category: "transport", created_by: priya,
...
vote!(entry: teamlab, user: priya, score: 2)
vote!(entry: teamlab, user: sam, score: 2)
vote!(entry: nanzenji, user: priya, score: 1)
vote!(entry: nanzenji, user: sam, score: 2)
vote!(entry: ramen_dinner, user: priya, score: 0)
vote!(entry: ramen_dinner, user: sam, score: 1)
vote!(entry: kaiseki_dinner, user: priya, score: 2)
vote!(entry: kaiseki_dinner, user: sam, score: -1)
vote!(entry: pocket_wifi, user: priya, score: 1)
...
malaysia = entry!(kind: "trip", title: "Malaysia", created_by: sam, description: "Not yet sure how many days.")

penang = entry!(kind: "idea", title: "Penang", category: "place", created_by: sam, lat: 5.4141, lng: 100.3288)
melaka = entry!(kind: "idea", title: "Melaka", category: "place", created_by: sam, lat: 2.1896, lng: 102.2501)
bali = entry!(kind: "idea", title: "Bali", category: "place", created_by: priya, lat: -8.3405, lng: 115.0920)
[penang, melaka, bali].each { |sibling| link!(parent: malaysia, child: sibling) }

vote!(entry: penang, user: sam, score: 2)
vote!(entry: penang, user: priya, score: 1)
vote!(entry: melaka, user: sam, score: 1)
vote!(entry: bali, user: priya, score: 2)
vote!(entry: bali, user: sam, score: -2)
...
saigon_idea = entry!(
  kind: "idea", title: "Saigon street food crawl", category: "food", created_by: priya,
  notes: "Saw this on Instagram, no trip planned yet.",
  source_url: "https://instagram.com/p/example-saigon"
)
vote!(entry: saigon_idea, user: priya, score: 2)
